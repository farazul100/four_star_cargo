            ...
            return (
              ...
              >
                <div>
                  ...
                  <div className={`flex items-start justify-between gap-2 border-b pb-3.5 ${isDark ? 'border-slate-700' : 'border-slate-100'}`}>
                    <div className="flex items-center space-x-3">
                  ...
                  <div className={`mt-4 pt-3 border-t space-y-2.5 ${isDark ? 'border-slate-700' : 'border-slate-100'}`}>
                    ...
                    <div className="space-y-1.5">
                      {staffList.length === 0 ? (
                        <div className={`p-2.5 rounded-none border text-center text-xs font-light ${
                          isDark ? 'bg-[#1E293B] border-slate-700 text-slate-400' : 'bg-slate-50 border-slate-200 text-slate-500'
                        }`}>
